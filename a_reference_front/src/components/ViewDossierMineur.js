...
const Section = ({ title, icon, children, collapsible = false }) => {
  ...
  return (
    <div className="mt-4 border border-gray-200 rounded-lg shadow-sm bg-white overflow-hidden">
      <div 
        className={`bg-gradient-to-r from-purple-50 to-purple-100 p-4 border-b border-gray-200 ${collapsible ? 'cursor-pointer hover:bg-purple-200' : ''}`}
        onClick={() => collapsible && setIsOpen(!isOpen)}
      >
        <h3 className="text-lg font-semibold text-purple-900 flex items-center justify-between">
          <span>
...
const ViewDossierMineur = ({ patient, onBack, language = "fr", dossierProp = null }) => {
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">⏳ Chargement du dossier pédiatrique...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-gray-50 min-h-screen">
      ...
      {page && (
        <>
          {/* Sections spécifiques aux mineurs */}
          
          {/* Informations Parentales - Uniquement pour mineurs */}
          ...
          {/* Naissance - Uniquement pour mineurs */}
          ...
          {/* Statut Vaccinal - Uniquement pour mineurs */}
          <Section title="💉 Statut Vaccinal" icon="💉" collapsible>
            <div className="mb-4">
          ...
          {/* Répondants Légaux - Uniquement pour mineurs */}
          ...
          {/* Sections communes (adultes et mineurs) */}
      ...
      <div className="mt-8 flex justify-center">
        <button
          onClick={onBack}
          className="px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg hover:from-purple-700 hover:to-purple-800 transition-all shadow-lg flex items-center text-lg"
        >
          🔙 {getTranslation("retour", language)}
        </button>
      </div>
...
export default ViewDossierMineur;
