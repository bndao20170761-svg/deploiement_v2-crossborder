...
/**
 * Conteneur des triggers (onglets)
 */
    ...
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "data-[state=active]:bg-background dark:data-[state=active]:text-foreground " +
          ...
          "items-center justify-center gap-1.5 rounded-md border border-transparent px-2 py-1 text-sm " +
...
/**
 * Contenu affiché pour un onglet actif
 */
