const MICROSERVICES_CONFIG = {
  GATEWAY: {
    url: process.env.REACT_APP_GATEWAY_URL || 'http://100.48.20.109:8080',
    name: 'API Gateway',
    port: 8080,
    description: 'Gateway principal pour tous les services'
  },
  USER_API: {
    url: process.env.REACT_APP_USER_API_URL || 'http://100.48.20.109:8080/api',
    name: 'User API',
    port: 8080,
  ...
  FRONTEND_1: {
    url: process.env.REACT_APP_FRONTEND1_URL || 'http://100.48.20.109:3002',
    name: 'Frontend 1',
    port: 3001,
