export const translations = {
  ...
  noDoctorFound: {
    ...
    en: 'No doctor found',
    pt: 'Nenhum médico encontrado'
  },

  // Assurez-vous que ces traductions existent aussi :
  ...
  actions: { fr: 'Actions', en: 'Actions', pt: 'Ações' },
   modifierDoctor: {
      fr: 'Modifier le Médecin',
      en: 'Edit Doctor',
      pt: 'Editar Médico'
    },
    enregistrerDoctor: {
      fr: 'Enregistrer un Médecin',
      en: 'Register Doctor',
      pt: 'Registrar Médico'
    },
    codeDoctor: {
    ...
    chooseHospital: {
      fr: 'Choisir un hôpital',
      en: 'Choose a hospital',
      pt: 'Escolher um hospital'
    },
    lastName: {
      fr: 'Nom',
      en: 'Last Name',
    ...
    passwordLeaveBlank: {
      fr: 'Laisser vide pour ne pas modifier le mot de passe',
      en: 'Leave blank to keep current password',
      pt: 'Deixe em branco para manter a senha atual'
    },
    choose: {
      fr: 'Choisir...',
      en: 'Choose...',
    ...
    phone: { fr: 'Téléphone', en: 'Phone', pt: 'Telefone' },
    hospital: { fr: 'Hôpital', en: 'Hospital', pt: 'Hospital' },
    ...
    save: { fr: 'Enregistrer', en: 'Save', pt: 'Salvar' },
     assistantList: {
        fr: 'Liste des Assistants Sociaux',
        en: 'Social Assistants List',
        pt: 'Lista de Assistentes Sociais'
      },
      workplace: {
        fr: 'Lieu d\'exercice',
        en: 'Workplace',
      ...
      noAssistantFound: {
        fr: 'Aucun assistant social trouvé',
        en: 'No social assistant found',
        pt: 'Nenhum assistente social encontrado'
      },

      // Traductions communes (assurez-vous qu'elles existent)
      search: { fr: 'Rechercher', en: 'Search', pt: 'Pesquisar' },
      filter: { fr: 'Filtrer', en: 'Filter', pt: 'Filtrar' },
      name: { fr: 'Nom', en: 'Name', pt: 'Nome' },
      phone: { fr: 'Téléphone', en: 'Phone', pt: 'Telefone' },
      ...
      assistant: {
        ...
        addAssistant: {
          fr: 'Ajouter Assistant',
          en: 'Add Assistant',
          pt: 'Adicionar Assistente'
        },
          // Association Form
          modifierAssociation: {
            fr: 'Modifier Association',
            en: 'Edit Association',
            pt: 'Editar Associação'
          },
          enregistrerAssociation: {
            fr: 'Enregistrer Association',
            en: 'Register Association',
            pt: 'Registrar Associação'
          },
          codeAssociation: {
            fr: 'Code Association',
            en: 'Association Code',
            pt: 'Código Associação'
          },
          emailUser: {
          ...
          emailUserHelp: {
            fr: 'Email de l\'utilisateur à associer',
            en: 'Email of the user to associate',
            pt: 'Email do utilizador a associar'
          },
          district: {
            fr: 'Quartier',
            en: 'District',
          ...
          associationList: {
            ...
            en: 'Association List',
            pt: 'Lista de Associações'
          },
          noAssociationFound: {
            fr: 'Aucune Association Trouvée',
            en: 'No Association Found',
            pt: 'Nenhuma Associação Encontrada'
          },
          associationInfo: {
            fr: 'Informations Association',
            en: 'Association Information',
            pt: 'Informações da Associação'
          },
          locationInfo: {
            fr: 'Informations Localisation',
          ...
          addAssociation: {
            fr: 'Ajouter Association',
            en: 'Add Association',
            pt: 'Adicionar Associação'
          },
          associationList: {
            fr: 'Liste Associations',
            en: 'Association List',
            pt: 'Lista Associações'
          },
        assistantList: {
          fr: 'Liste Assistants',
          en: 'Assistant List',
          pt: 'Lista de Assistentes'
        }, // Traductions pour MembreForm
            modifierMembre: {
              fr: 'Modifier Membre',
              en: 'Edit Member',
              pt: 'Editar Membro'
            ...
            chooseAssociation: {
              fr: 'Choisir une association',
              en: 'Choose an association',
              pt: 'Escolher uma associação'
            },
            userType: {
            ...
            selectUser: {
              ...
              en: 'Select a user',
              pt: 'Selecionar um usuário'
            },
            chooseUser: {
              fr: 'Choisir un utilisateur',
              en: 'Choose a user',
              pt: 'Escolher um usuário'
            },
            email: {
              fr: 'Email',
              en: 'Email',
            ...
            autoGenerated: {
              fr: 'Informations générées automatiquement',
              en: 'Auto-generated Information',
              pt: 'Informações Geradas Automaticamente'
            },
            membreAutoInfo: {
              fr: 'Le code membre et le pseudo seront générés automatiquement après l\'enregistrement.',
              en: 'Member code and username will be automatically generated after saving.',
              pt: 'O código do membro e o nome de usuário serão gerados automaticamente após salvar.'
            },
            cancel: {
              fr: 'Annuler',
              en: 'Cancel',
            ...
            errorLoadingAssociations: {
              fr: 'Erreur lors du chargement des associations',
              en: 'Error loading associations',
              pt: 'Erro ao carregar associações'
            },
            selectAssociation: {
              fr: 'Veuillez sélectionner une association',
              en: 'Please select an association',
              pt: 'Por favor, selecione uma associação'
            },
            fillAllUserFields: {
              fr: 'Veuillez remplir tous les champs utilisateur',
              en: 'Please fill all user fields',
              pt: 'Por favor, preencha todos os campos do usuário'
            },
            memberSavedSuccess: {
              fr: 'Membre enregistré avec succès !',
              en: 'Member saved successfully!',
              pt: 'Membro salvo com sucesso!'
            },
            errorSavingMember: {
              fr: 'Erreur lors de l\'enregistrement du membre',
              en: 'Error saving member',
              pt: 'Erro ao salvar membro'
            },
            loadingAssociations: {
              fr: 'Chargement des associations...',
              en: 'Loading associations...',
              pt: 'Carregando associações...'
            },
            noAssociationsAvailable: {
              fr: 'Aucune association disponible. Veuillez d\'abord créer une association.',
              en: 'No associations available. Please create an association first.',
              pt: 'Nenhuma associação disponível. Por favor, crie uma associação primeiro.'
            },
            loading: {
              fr: 'Chargement',
              en: 'Loading',
       ...
       membreList: {
        ...
        allAssociations: {
          fr: 'Toutes les associations',
          en: 'All associations',
          pt: 'Todas as associações'
        },
        username: {
          fr: 'Pseudonyme',
          en: 'Username',
      ...
      addHospital: {
        fr: 'Ajouter Hôpital',
        en: 'Add Hospital',
        pt: 'Adicionar Hospital'
      },
      hospitalList: {
        fr: 'Liste Hôpitaux',
        en: 'Hospital List',
        pt: 'Lista de Hospitais'
      },
